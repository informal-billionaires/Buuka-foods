      ...
      <div className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <main className="max-w-4xl mx-auto px-4 py-20">
          <div className="bg-white border border-neutral-200 rounded-2xl p-8 text-center">
            <div className="text-neutral-500">Loading restaurant…</div>
          </div>
        </main>
      </div>
    );
      ...
      <div className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <main className="max-w-4xl mx-auto px-4 py-20">
          <div className="bg-white border border-neutral-200 rounded-2xl p-8 text-center">
            ...
            <p className="text-sm text-neutral-500 mb-6">We couldn't find this restaurant or it is not available.</p>

            <div className="flex justify-center gap-3">
              <Link href="/browse" className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-primary text-white text-sm font-semibold">
                Back to browse
              </Link>
            </div>
          </div>
      ...
      <div className="min-h-screen bg-neutral-50 text-neutral-900">
          ...
          <div className="bg-white border border-neutral-200 rounded-2xl p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <div className="text-sm text-neutral-500 mt-1">{restaurant?.cuisine}</div>
              </div>
          ...
          <div className="mt-6 grid gap-4">
            <div className="bg-white border border-neutral-200 rounded-2xl p-6">
              ...
              {menuSections.length === 0 ? (
                <div className="text-neutral-500 mt-4">No menu items yet.</div>
              ) : (
                <div className="mt-4 space-y-6">
                  {menuSections.map(section => (
                    <section key={section.id}>
                      <h3 className="text-sm font-semibold text-neutral-500 mb-3">{section.title}</h3>
        ...
        <div className="fixed bottom-4 left-0 right-0 flex justify-center pointer-events-none">
          <div className="w-full max-w-4xl px-4 pointer-events-auto">
            <div className="bg-white border border-neutral-200 shadow-lg rounded-2xl p-3 flex items-center justify-between">
              <FulfillmentToggle value={fulfillmentType} onChange={(v) => setFulfillmentType(v)} />
              <div className="flex items-center gap-3">
                <div className="text-sm text-neutral-900">Total: {total}</div>
                <button onClick={() => setDrawerOpen(true)} className="px-4 py-2 rounded-full bg-primary text-white text-sm font-semibold">View Cart</button>
              </div>
            </div>
          </div>
        </div>
